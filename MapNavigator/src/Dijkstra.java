...
public class Dijkstra {
    ...
    public static void shortestPathBetween(Graph g, Vertex startingVertex, Vertex targetVertex) {
        ...
        System.out.println("\nTravelling from " + startingVertex.getData() + " to " + targetVertex.getData());
